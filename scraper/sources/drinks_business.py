"""The Drinks Business Jobs scraper."""
...
BASE_URL = "https://www.thedrinksbusiness.com"
...
class DrinksBusinessScraper(BaseScraper):
    ...
    async def fetch_listings(
        ...
        try:
            ...
            logger.warning("DrinksBusinessJobs returned %d", exc.response.status_code)
            return jobs
        ...
        for card in cards:
            try:
                ...
                logger.debug("DrinksBusinessJobs card parse error: %s", exc)
